  ...
  return (
    <div className="relative flex aspect-[3/4] items-end overflow-hidden rounded-md bg-secondary shadow-lg shadow-black/25">
      <CoverImage
        ...
        className="absolute inset-0 size-full object-cover transition duration-300 group-hover:scale-105 motion-reduce:transition-none motion-reduce:transform-none"
      />
...
export function StoryCard({ series }: { series: SeriesWithRelations }) {
  ...
  return (
    <article className="group min-w-0 rounded-lg border bg-card/90 p-2.5 transition hover:-translate-y-0.5 hover:border-accent/60 hover:bg-card motion-reduce:transition-none motion-reduce:hover:translate-y-0">
